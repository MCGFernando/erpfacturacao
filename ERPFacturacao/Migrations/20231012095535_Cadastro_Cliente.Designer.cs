...
namespace ERPFacturacao.Migrations
{
    ...
    [Migration("20231012095535_Cadastro_Cliente")]
            ...
            modelBuilder.Entity("ERPFacturacao.Model.Artigo", b =>
                {
                    ...
                    b.Property<int>("TipoProductoServicoId")
                        .HasColumnType("int");

                    b.Property<string>("_ProductoServico")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("TipoProductoServicoId");
            ...
            modelBuilder.Entity("ERPFacturacao.Model.Artigo", b =>
                {
                    ...
                    b.HasOne("ERPFacturacao.Model.TipoArtigo", "TipoProductoServico")
                        .WithMany()
                        .HasForeignKey("TipoProductoServicoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("TipoProductoServico");
                });
            ...
            modelBuilder.Entity("ERPFacturacao.Model.ContaBancaria", b =>
                {
                    ...
                    b.HasOne("ERPFacturacao.Model.Cliente", "ClienteFonecedor")
                        .WithMany("ContasBancarias")
                        .HasForeignKey("ClienteFonecedorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERPFacturacao.Model.Fornecedor", null)
                        .WithMany("ContasBancarias")
                        .HasForeignKey("FornecedorId");
